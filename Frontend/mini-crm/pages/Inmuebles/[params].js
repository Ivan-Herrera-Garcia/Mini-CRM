            ...
            <ul>
                {inmuebles.map((inmueble) => (
                    <div key={inmueble._id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="p-5" onClick={() => window.open("/Inmuebles/"+inmueble._id, "#")}>
                            <a href="#">
                            ...
                            <div className="flex items-center justify-between">
                                <a target="_blank" href={inmueble.urlInmueble} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-green-500 dark:hover:bg-green-500 dark:focus:bg-green-500">
                                    Editar
                                </a>
                                <a target="_blank" href={inmueble.urlInmueble} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
